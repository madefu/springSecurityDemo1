    ...
    public static void main(String[] args) {
        try {
            ...
            for (int j = 0; j < 10; j++) {
                ...
                String pwd = "122333";
                String totp = generateMyTOTP(account, pwd);
                System.out.println(String.format("加密后: %s", totp));
                Thread.sleep(1000);

                System.out.println(TOTP.verifyTOTPFlexibility(account,pwd,totp));
                System.out.println(TOTP.verifyTOTPRigidity(account,pwd,totp));
            }
